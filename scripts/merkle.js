...
for (let i = 0; i < rawAddresses.length; i++) {
 ...
 export let whitelistAddresses = [
    ...
    ethers.utils.solidityKeccak256(['uint256', 'address'], [90, ethers.utils.getAddress(addresses[90])]),
